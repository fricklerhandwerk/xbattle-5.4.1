...
struct hue_default_info Hues[MAX_HUES] = {
	{"back",	210, 220, 150, 1,
...
int Palette_Hills[MAX_HILL_TONES][3] =		{{175, 220, 100},
						 {200, 175, 100}};

int Palette_Forest[MAX_FOREST_TONES][3] =	{{  0, 200,   0},
						 {  0, 120,   0}};

int Palette_Sea[MAX_SEA_TONES][3] =		{{ 70, 132, 200},
						 { 30,  65, 185}};
